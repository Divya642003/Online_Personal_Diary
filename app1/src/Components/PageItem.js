...
export default function PageItem(props) {
    ...
    const{setView,deletePage,showAlert}=useContext(pageContext);

    const handleClick=(e)=>{
        
        setView({title:page.title,description:page.description,tag:page.tag,date:page.date.toString().substring(0,10)});
  ...
  return (
    ...
    <div className='col-md-3'>
        ...
        <p className="card-text">{page.description.toString().substring(0,65)+"..."}</p>
