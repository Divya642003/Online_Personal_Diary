...
export default function Pages()
{
    ...
    useEffect(()=>{
       ...
       {fetchPages();
        setView({title:"",description:"",tag:"",date:""});}
        else{
    ...
    return(
             ...
             <form >
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="description" name="description" value={page.description} minLength={10} onChange={handleChange} />
                </div>
                <div className="mb-3">
